...
def main():
    ...
    # -------------------------------------------------------------------------
    print(f"\n{'─' * 90}")
    print("CORPUS: KGLite — 163K files, 39GB (Rust project)")
    print(f"{'─' * 90}")
    ...
    # -------------------------------------------------------------------------
    print(f"\n{'─' * 90}")
    print("CORPUS: Scraping/processed — 53K files, 2.1GB (HTML corpus)")
    print(f"{'─' * 90}")
    ...
    # -------------------------------------------------------------------------
    print(f"\n{'─' * 90}")
    print("COMBINED: Both corpora as multiple source_dirs")
    print(f"{'─' * 90}")
